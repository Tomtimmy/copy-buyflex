...
export const BestSellers: React.FC<BestSellersProps> = ({ products, onSelectProduct }) => {
  return (
    <section className="animate-fade-in">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl font-bold text-white mb-8 text-center">Our Best Sellers</h2>
